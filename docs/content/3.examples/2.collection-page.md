...
This example will show you how to create a collection page for your Shopify store in Nuxt.

::card
  :::tabs
    ::::tabs-item{icon="i-lucide-eye" label="Preview"}
      :::::example-collection-page{handle="accessoires" .pt-2}
      :::::
    ::::
...
In order to follow this example, you need to have at least one collection with products set up in your Shopify store.
