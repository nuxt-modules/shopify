...
description: How to create a navigation menu for your Shopify store in Nuxt
navigation:
  icon: i-lucide-menu
seo:
  title: Navigation Menu
...
This example will show you how to create a navigation menu for your Shopify store in Nuxt.

::card
  :::tabs
    ::::tabs-item{icon="i-lucide-eye" label="Preview"}
      :::::example-navigation-menu{handle="main-menu" .justify-center .pt-2}
      :::::
    ::::

    ::::tabs-item{icon="i-lucide-code" label="Code"}
      :::::code-tree{default-value="app/components/NavigationMenu.vue" :expand-all="true"}
      ```vue [app/components/NavigationMenu.vue]
...
In order to follow this example, you need to have a navigation menu set up in your Shopify store.
...
First, we create a new component `components/NavigationMenu.vue`.
...
```vue [~/components/NavigationMenu.vue]
<script setup lang="ts">
