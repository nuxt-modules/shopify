...
::field-group
  ...
  Auto-import the generated types for this client - default: `true` for the storefront client, `false` otherwise
  :::
  ...
  Glob patterns to include in [code generation](/essentials/codegen). Setting this replaces the default glob patterns for the client
  :::
...
::field-group
  ...
  :::field{name="codegen.autoImport" type="boolean"}
  Auto-import the generated types for this client - default: `false` (only the storefront client auto-imports by default)
  :::
...
::field-group
  ...
  :::field{name="codegen.autoImport" type="boolean"}
  Auto-import the generated types for this client - default: `false` (admin only enabled when explicitly set)
  :::
  ...
  shopify: {
    ...
    clients: {
      ...
      customerAccount: {
        ...
        apiURL: "https://shopify.com/authentication/YOUR_SHOP_ID/graphql",
