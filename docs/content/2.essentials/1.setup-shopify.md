...
To use the Customer Account API, you need to enable it in your Shopify store via the [Shopify Headless app](https://apps.shopify.com/headless).
...
You should now see the client ID and client secret for the Customer Account API.
You can also set scopes and permissions for the Customer Account API from this interface.
::
