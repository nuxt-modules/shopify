...
- .nuxt/schema/customer-account.schema.json
- .nuxt/types/customer-account/customer-account.types.d.ts
- .nuxt/types/customer-account/customer-account.operations.d.ts
...
- .nuxt/graphql.config.mjs

A [graphql-config](https://the-guild.dev/graphql/config) file with one project per configured client, used to power
IDE autocompletion and validation. See [Editor Setup](/getting-started/editor) for how to enable it.
